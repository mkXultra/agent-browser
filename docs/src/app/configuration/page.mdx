...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>AI_GATEWAY_API_KEY</code></td><td>API key for Vercel AI Gateway. Required for AI chat and Vercel goal mode.</td><td>(none)</td></tr>
    ...
    <tr><td><code>AGENT_BROWSER_GOAL_PROVIDER</code></td><td>Provider for the <code>goal</code> command: <code>vercel</code> or <code>cloudflare</code>.</td><td><code>vercel</code></td></tr>
    <tr><td><code>AGENT_BROWSER_GOAL_MODEL</code></td><td>Evaluation model for the <code>goal</code> command.</td><td>Provider default: <code>typesafe-ai/jev</code> or <code>typesafe/jev</code></td></tr>
    <tr><td><code>AGENT_BROWSER_GOAL_TEXT_MODEL</code></td><td>Text model that writes <code>TYPE_TEXT</code> values for the <code>goal</code> command.</td><td>Provider default: <code>inception/mercury-2.5</code> or <code>@cf/qwen/qwen3-30b-a3b-fp8</code></td></tr>
    <tr><td><code>CLOUDFLARE_ACCOUNT_ID</code></td><td>Cloudflare account ID for Cloudflare goal mode.</td><td>(none)</td></tr>
    <tr><td><code>CLOUDFLARE_API_TOKEN</code></td><td>Cloudflare API token with Account &gt; Workers AI &gt; Read permission for Cloudflare goal mode.</td><td>(none)</td></tr>
    <tr><td><code>CLOUDFLARE_AI_GATEWAY_ID</code></td><td>AI Gateway ID used for Cloudflare goal requests.</td><td><code>default</code></td></tr>
  </tbody>
</table>
