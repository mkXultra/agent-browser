...
After approval, an ordinary command prints the executed command response rather than the confirmation envelope, and the process exit status reflects that inner result.
